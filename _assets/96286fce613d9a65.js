  ...
  [60060],
  {
    /***/ 82986: function (_, __, __webpack_require__) {
      ...
      (function (__c) {
        ...
        __c.G5 = function (a, b, c) {
          return { key: a, cWa: b, type: "string", EJ: c, bTa: 0 };
        };
        __c.H5 = function (a) {
          return () => ({ ...q8b, ...a });
        };
        s8b = function ({ element: a }) {
          var b = r8b.get(a.ima);
          if (!b) throw Error(`Blueprint ${a.ima} not found`);
          b = b.variants.find((c) => c.fDa === a.fDa);
          if (!b)
            throw Error(`Variant ${a.fDa} not found for blueprint ${a.ima}`);
          return { Pa: b.Pa };
        };
        t8b = function (a, b) {
          return __c.F5()(() => ({
        ...
        v8b = async function (a, b) {
          const c = b.requestId,
            d = b.path;
          b = b.payload;
          const e = a.requestHandler.get(d);
          if (e) {
            a.C2.sY.send({ type: "ack", requestId: c });
            var f = setInterval(
              () => a.C2.sY.send({ type: "ack", requestId: c }),
              9e3
            );
            try {
              var g = await e(b);
              clearInterval(f);
              a.C2.sY.send({ type: "response", requestId: c, payload: g });
            } catch (k) {
              clearInterval(f);
              g = "internal_error";
              b =
            ...
            if (h != null)
              for (const k of a.$cb)
                try {
                  ...
                  a.F.nG(l, { te: "Error executing errorObserver" });
                }
          } else
            (h = u8b(
              a.C2,
        ...
        x8b = function ({ src: a, srcdoc: b, sandbox: c }) {
          if (b.length !== 0 || !c.contains("allow-same-origin")) return w8b;
          a = new URL(a).origin;
          return a === "null" ? w8b : { cDa: a, CYa: a };
        };
        A8b = async function (
          a,
          b,
            ...
            (k === null || k === void 0
              ...
              (m !== g.cDa
                ...
                : ((l = k
                  ...
                  l.ok
                    ? (h.postMessage({ source: "parent" }, g.CYa, [a]),
                      f.resolve(void 0))
                    : b.JK(l.error, {
                        extra: new Map([
                          [
        ...
        z8b = function (a) {
          return B8b.some((b) => a.endsWith(b));
        };
        E8b = function (a, b) {
          var c = C8b,
            d = D8b;
        ...
        I8b = async function (a, b) {
          a = await a.VIa.request("RENDER_ELEMENT", F8b.Sb(b));
          a = G8b(a, "RENDER_ELEMENT");
          return H8b.Gb(a);
        };
        L8b = async function (a, b) {
          a = await a.VIa.request("SET_CAPABILITY", J8b.Sb(b));
          a = G8b(a, "SET_CAPABILITY");
          return K8b.Gb(a);
        };
        M8b = function (a, b) {
          E8b(a, (c) => b.sgb(c));
        ...
        P8b = async function (a, b, c) {
          const { port1: d, port2: e } = new MessageChannel(),
            f = new N8b(d, b);
          await A8b(e, b, a, window);
          a = new O8b(f);
          c && M8b(f, c);
          return a;
        };
        S8b = function ({ F: a }) {
          const b = new Q8b(),
            c = new R8b(b, a);
          return t8b(
            ({ data: { element: d }, Ez: { a5a: e } }) =>
              J5(e, { url: d.url, yB: (f) => c.yB(f, d), yU: (f) => c.yU(f) }),
            b
          );
        };
        T8b = function (a) {
        ...
        U8b = function (a) {
          const b = a.color;
          a = a.ab;
          return b ? b : a.ref ? a.ref.Wi[0].color : "#ffffff";
        };
        K5 = function (a, b) {
        ...
        Z8b = function (a) {
          ...
          return J5("div", {
            className: "LMc7Uw",
            children: a.options.map((d) => J5(Y8b, { children: b(d) }, c(d))),
          });
        };
        a9b = function (a) {
          const b = a.iw,
          ...
          const e = b !== c,
            f = $8b(() => {
              var g = K5(c, M5),
                h = e ? b : g;
              g = __c.Is("#000000", c) >= 20 ? "#000000" : K5(c, M5);
              h = __c.Is(h, c) >= 20 ? h : K5(c, M5);
              return d && e ? h : g;
            }, [e, d, b, c]);
          return J5("div", {
            className: "WYWuyA",
            style: {
              "--bETJ2A": d
                ? __c.xs(__c.rs(__c.ss(f), e ? 0.5 : 0.08))
                : __c.xs(__c.rs(__c.ss(f), 0.08)),
              "--yYV0bA": __c.xs(__c.rs(__c.ss(f), 0.12)),
              "--mxkqAA": __c.xs(__c.rs(__c.ss(f), 0.26)),
            },
            children: a,
          });
        };
        b9b = function (a) {
          return J5("div", {
            className: "B_d8Sg",
            children: J5("div", { children: a.Ztb }),
          });
        };
        g9b = function (a) {
          const b = a.status,
          ...
          switch (b) {
            case 0:
              return N5(a.ada(), c, d, K5(e, c9b), f);
            case 1:
              return N5(a.loading(), c, d, K5(e, d9b), f);
            case 2:
              return N5(a.Mza(), c, d, K5(e, d9b), f);
            case 3:
              return N5(a.offline(), c, d, K5(e, e9b), f);
            case 4:
              return N5(a.hza(), c, d, K5(e, f9b), f);
            default:
              throw new E(b);
          }
        };
        h9b = function (a) {
          return J5("div", { children: a.label });
        };
        __c.sd.prototype.PL = __c.fa(3, function (a, b) {
          this.console.error(...__c.rd(this, "critical", a, b));
        });
        __c.pL.prototype.PL = __c.fa(2, function (a, b) {
          this.kt.PL(a, b);
        ...
        i9b = P5.action;
        j9b = P5.observable;
        k9b = P5.ObservableMap;
        l9b = P5.reaction;
        m9b = P5.untracked;
        var n9b = __webpack_require__(443763),
          J5 = n9b.jsx,
          Q5 = n9b.jsxs;
        var R5 = __webpack_require__(875604),
          ...
          $8b = R5.useMemo,
          S5 = R5.useState;
        var q9b = __webpack_require__(635872).Om;
        var r9b = __webpack_require__(446474).Pi;
        var q8b = Object.freeze({
        ...
        var r8b = new k9b(),
          s9b = __c.H5({
            element: {
              ima: __c.G5("blueprintId", 0),
              fDa: __c.G5("variantId", 0),
            },
          });
        var t9b = {
          qH: __c.F5()(() => ({ element: { type: 0, xD: s8b }, exports: {} })),
          rH: s9b,
        };
        var u9b = __c.H5({
          element: { url: __c.G5("url", 0), config: __c.G5("config", 1) },
        });
        var Q8b = class {};
        ...
        var v9b = class {
          constructor(a, b, c) {
            ...
            this.port.onmessage = this.iva;
            this.port.onmessageerror = this.Dnb;
          }
        };
        var w9b = class extends Error {
            constructor() {
        ...
        var N8b = class {
            constructor(a, b) {
                    ...
                    case "response":
                      ...
                      if (g)
                        switch (f) {
                          ...
                          case "error":
                            g.reject(
                              new I5({ code: c.code, message: c.message })
                            );
                            break;
                          default:
                            throw new E(c);
              ...
              this.client = new x9b(a.cz, b.Tf("client"));
              this.requestHandler = new y9b(a, b.Tf("requestHandler"));
            }
          },
          z9b = class {
            constructor(a, b, c) {
              ...
              this.Pnb = (d) => {
                switch (d.type) {
                  case "ack":
                    this.pba({ type: "ack", requestId: d.requestId });
                    break;
                  case "error":
                    this.pba({
                      type: "error",
              ...
              this.sY = new v9b({ nqb: this.Pnb }, b, c);
            }
          };
        var w8b = { cDa: "null", CYa: "*" };
        var B8b =
        ...
        var F8b = M(() => ({ config: __c.Y(1) }));
        var T5 = M(() => ({
          type: __c.F("A?", 1, "RECOLORABLE"),
          id: X(1),
          value: X(2),
        }));
        var A9b = M(() => ({ borderRadius: PL(1), borderWidth: PL(2) }));
        var U5 = M(() => ({
        ...
        var K8b = M(() => ({ config: X(1), width: PL(2), height: PL(3) }));
        var C8b = M(() => ({
          config: X(1),
          width: PL(2),
          height: PL(3),
        ...
        var R8b = class {
          async yB(a, b) {
            ...
            const f = await P8b(a, this.F, c);
            c = l9b(
              () => b.config,
              async (g) => {
                const h = await I8b(f, { config: g });
                h.config &&
                  h.config !== g &&
                  (e === null || e === void 0 || e.y2a(h, b, d));
              }
            );
            this.kh.set(a, c);
            a = await I8b(f, { config: b.config });
            e === null || e === void 0 || e.y2a(a, b, d);
          }
          yU(a) {
            var b;
        ...
        var M5 = ["#000000", "#ffffff"],
          B9b = q9b((a, b) => {
            const c = pl.create(pl.ja(a));
            m9b(() => {
              c.Zg({ direction: T8b(b) });
            });
            return c;
          });
        qr();
        ...
        ((a) => ({
          ...
          label: L5(
            O("RHbyaA"),
            V8b("#05805f", a === null || a === void 0 ? void 0 : a.fontFamily)
          ),
          options: [O("ubIbsA"), O("Ic3T0Q"), O("gWITaA"), O("VqqAfQ")].map(
            (b) => ({
              id: qr(),
              label: L5(
                b,
                W8b(
                  "#05805f",
                  a === null || a === void 0 ? void 0 : a.fontFamily
                )
              ),
            })
          ),
        ...
        __c.oD.create({ ...__c.DQ, weight: 0, color: "#000000" });
        __c.LO.create({ ...__c.Ru, color: "#05805f" });
        __c.LO.create({ ...__c.Ru, color: "#05805f" });
        var C9b,
          D9b = qr(),
          E9b = qr(),
          F9b = [
            ((a) => {
              const b = [
                { id: qr(), label: O("yNxreA"), n1: !1 },
                { id: qr(), label: O("1KKyZA"), n1: !0 },
                { id: qr(), label: O("U+9/CQ"), n1: !1 },
              ];
              return {
                type: "select",
                id: qr(),
        ...
        C9b = {
          ...
          header: {},
          B0: !1,
          border: __c.oD.create({ ...__c.DQ, weight: 0, color: "#000000" }),
          X: 16,
          mu: __c.LO.create({ ...__c.Ru, color: "#0079a9" }),
          uu: __c.LO.create({ ...__c.Ru, color: "#0079a9" }),
          zm: __c.Ch.Gc["font-family"],
          direction: "l",
          ...void 0,
        };
        var H9b = __c.H5({ element: __c.O5 });
        var I9b = {
            resultsPercentage: 0,
          ...
          J9b = class {
            ...
            gi(a) {
              ...
              return (((b = this.sC) === null || b === void 0
                ? void 0
                : b.get(this.document.language || "en")) || [])[I9b[a]];
            }
            hza() {
              return this.gi("somethingWentWrong") || O("Z3F9sQ");
            }
            ada() {
              return this.gi("live") || O("2LB66w");
            }
            zJa() {
              return this.gi("correctLabel") || O("uXYgEw");
            }
            HOa() {
              return this.gi("incorrectLabel") || O("Pe58VA");
            }
            DXa() {
              return this.gi("responseSaved") || O("JWFDXg");
            }
            uTa(a) {
            ...
            offline() {
              return this.gi("offline") || O("H7ta1A");
            }
            loading() {
              return this.gi("loading") || O("/0w0UQ");
            }
            Mza() {
              return this.gi("submitting") || O("+ecJQQ");
            }
            YDa() {
              return this.gi("yourNameWontBeShared") || O("lC0Mpw");
            }
            XDa() {
              return this.gi("yourNameWillBeShared") || O("rrumFQ");
            }
            constructor(a) {
              this.document = a;
              this.sC = (J9b.A(this), void 0);
              X8b().then(
                i9b((b) => {
                  this.sC = b;
                })
        ...
        var L9b = r9b(function (a) {
          ...
          const [q] = S5(
            ...
            r = $8b(() => q9b((x) => J5(d, { text: B9b(x, f) })), [d, f]),
            t = U8b(h),
            v = U8b(k),
            [w] = S5(() => 1);
          return Q5("div", {
            ...
            children: [
              J5("div", { className: "wNGpBA", children: J5(e, { fill: k }) }),
              a.map((x) =>
                Q5(
                  "div",
                  {
                      ...
                      !g &&
                        Q5("div", {
                          ...
                          children: [
                            J5("div", {
                              className: "f_lCRg",
                              children: J5(e, { fill: h }),
                            }),
                            J5(h9b, { label: r(x.label.text) }),
                          ],
                        }),
                      J5("div", {
                        className: "CljvBQ",
        ...
        var M9b = {
          qH: (function (a) {
            return __c.F5()(() => ({ element: __c.E5(a), exports: {} }));
          })(
            o9b(({ Ez: a }) =>
              J5(L9b, { N5a: a.fFa, bX: a.bX, state: C9b, wA: "en" })
            )
          ),
          rH: H9b,
        };
        __c.uSa = {
          Shb: function (a) {
            function b(e, f) {
              const g = c.Phb(e, f.rH());
              f = d.Ohb(e, g, f.qH());
              return { id: e, pw: g, ZMb: f };
            }
            const c = a.IDa,
              d = a.W6;
            return {
              bBb: b("w:wnJF5T87v", t9b),
              SCb: a.mcb
                ? Promise.all([
                    __webpack_require__.me(697956).then(() => __c.N9b),
                    __webpack_require__.me(411625).then(() => __c.O9b),
                    __webpack_require__.me(305660).then(() => __c.P9b),
                    __webpack_require__.me(696820).then(() => __c.Q9b),
                  ]).then(([e, f, g, h]) => ({
                    OCb: b("w:cm9wgGptP", e),
                    PCb: b("w:yLMS4dWnl", f),
                    QCb: b("w:2flp30CGQ", g),
                ...
                : void 0,
              FBb: b("w:JR4G8hDDg", { rH: u9b, qH: S8b({ F: a.F }) }),
              form: b("w:6JG6DxspF", M9b),
              aPb: a.hcb
                ? __webpack_require__
                    .me(852979)
                    .then(() => __c.R9b)
                    .then((e) => b("w:2pbXJMtm1", e))
                : void 0,
            };
          },
        };
